...
>(function SelectIcon({ className, size, ...props }, ref) {
  ...
  const dimensionProps = props as { height?: number; width?: number };
  const hasExplicitDimensions = dimensionProps.height !== undefined || dimensionProps.width !== undefined;
  ...
  } else if (hasExplicitDimensions && size === undefined) {
    return (
      <UISelect.Icon
        ref={ref}
        {...props}
